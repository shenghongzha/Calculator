...
{
    HAL_I2C_Mem_Write(&hi2c1 , OLED << 1, 0x00, I2C_MEMADD_SIZE_8BIT, &Command, 1, 0x100);
//    OLED_I2C_Start();
//	OLED_I2C_SendByte(OLED);		//从机地址
...
{
    HAL_I2C_Mem_Write(&hi2c1 , OLED << 1, 0x40, I2C_MEMADD_SIZE_8BIT, &Data, 1, 0x100);
//	OLED_I2C_Start();
